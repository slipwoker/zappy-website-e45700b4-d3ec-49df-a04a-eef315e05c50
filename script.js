document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.dataset.minLength) {
        if (!VALIDATION_RULES.minLength(value, field.dataset.minLength)) {
  ...
  if (animatableElements.length > 0) {
    ...
    defaultStyles.textContent = [
      ...
      '.slide-up, .slide-in, .animate-on-scroll, [data-animate] {',
      '  opacity: 0;',
      '  transition: opacity 0.6s ease, transform 0.6s ease;',
      '}',
      '.fade-up, .slide-up { transform: translateY(40px); }',
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e45700b4-d3ec-49df-a04a-eef315e05c50',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e45700b4-d3ec-49df-a04a-eef315e05c50';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e45700b4-d3ec-49df-a04a-eef315e05c50';
